...
---
scenario: "${TEST}"
plugin_name: "pulp_rust"
legacy_component_name: "pulp_rust"
component_name: "rust"
...
image:
  ...
  webserver_snippet: $(test -f pulp_rust/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_rust"
    destination: "pulp_rust"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
